...
<!-- Set up list of journal entries -->
...
<{section name=i loop=$entries}>
  <tr>
    <td align="LEFT" class="odd"><{$entries[i].id}></td>
    <td align="LEFT" class="even"><{$entries[i].jrn_dt}></td>
    <td align="RIGHT" class="odd"><{$entries[i].jrn_prps}></td>
    <td align="RIGHT" class="even"><{$entries[i].row_flag}></td>
<!--
