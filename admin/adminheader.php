...
function xoops_module_admin_menu ($currentoption = 0, $breadcrumb = '')
{
	...
	*/
	include_once XOOPS_ROOT_PATH."/modules/".$modDir."/admin/menu.php";
...
if (file_exists(XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $xoopsConfig['language'] . '/main.php')) {
   include_once XOOPS_ROOT_PATH . '/modules/' . $modDir . '/language/' . $xoopsConfig['language'] . '/main.php';
} else {
   include_once XOOPS_ROOT_PATH . '/modules/' . $modDir . '/english/main.php';
}
