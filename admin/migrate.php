...
/** @var Xbssacc\Common\Configurator $configurator */
$configurator = new Xbssacc\Common\Configurator();

/** @var \XoopsModules\Xbssacc\Common\Migrate $migrator */
$migrator = new \XoopsModules\Xbssacc\Common\Migrate($configurator);
